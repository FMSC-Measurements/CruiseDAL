...
{
    public class LogGradeAuditRuleTableDefinition_3_5_5 : ITableDefinition
    {
...
CREATE INDEX NIX_LogGradeAuditRule_CruiseID_SpeciesCode ON LogGradeAuditRule (CruiseID, SpeciesCode);";
