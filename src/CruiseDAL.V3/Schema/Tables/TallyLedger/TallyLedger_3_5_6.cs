...
{
    public class TallyLedgerTableDefinition_3_5_6 : ITableDefinition
    {
...
CREATE INDEX NIX_TallyLedger_Created_TS ON TallyLedger (Created_TS);";
        ...
        public IEnumerable<string> CreateTriggers => new[]
        {
            ...
            CREATE_TRIGGER_TallyLedger_OnUpdate,
        };
...
END;";
        ...
        public const string CREATE_TRIGGER_TallyLedger_OnUpdate =
